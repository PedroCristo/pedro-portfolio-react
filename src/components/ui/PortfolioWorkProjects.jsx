...
function PortfolioWorkProjectsEn({ titleWork, classWork, workProjects, buttonWork, langPt }) {
  return (
          ...
          {workProjects.map((project) => (
           <div className={`card ${project.id === 8 ? "card-logo" : null}`} key={project.id}>
              ...
              >
                ...
                {project.id === 8 ? <img src="images/portfolio/logos/zarco_logo.png" alt="LOGO IMG" className="logo-box" /> : null}
              </a>
            </div>
          ))}
        </div>
